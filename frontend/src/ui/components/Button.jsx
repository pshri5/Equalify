...
const defaultStyles = 'flex items-center justify-center border-2'
const sizeStyle = {
    'sm' : 'py-2 px-4 gap-2 rounded-md w-40',
    'md' : 'py-2 px-6 gap-4 rounded-md w-60',
    'lg' : 'py-2 px-8 gap-6 rounded-lg w-80'
}
const variantStyles = {
